...
export interface MetricSeriesPoint { datasourceUid: string; instance: string; job: string; category: string; label: string; value: number; unit: string; collectedAt: string }
